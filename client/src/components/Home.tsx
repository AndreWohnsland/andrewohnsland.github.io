...
const Home: FunctionComponent = () => {
  useEffect(() => {
    document.title = `Home | ${import.meta.env.VITE_APP_SHOWN_NAME}`
  }, [])
  return (
    <>
      ...
      <main className="content-container h-100">
        <div className="main-text-page">
          <p>
            ...
            learning new technologies and tinker around with soft- and hardware
            of all kinds. That&#39;s how this homepage was born. In the process
            of learning React, I created this page to practice the framework and
            give me the possibility to present some of my work, as well as
            create blog entries.
          </p>
          <p>
          ...
          <p>
            ...
            the header. There is a list of some of my projects (mostly
            programming topics) and a section for blog entries. Also, there are
            some pictures from my hobby fotography and my other passion,
            woodworking with resign. For now, that&#39;s all, maybe next time
